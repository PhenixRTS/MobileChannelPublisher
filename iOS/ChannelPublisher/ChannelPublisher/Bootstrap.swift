...
final class Bootstrap {
        ...
        queue.sync(flags: [.barrier]) {
            ...
            do {
                ...
                DispatchQueue.main.async {
                    let viewController = self.makePublisherViewController(
                        core: core,
                        session: session
                    )
    ...
    private func makePublisherViewController(core: PhenixCore, session: AppSession) -> PublisherViewController {
        let viewModel = PublisherViewController.ViewModel(core: core, session: session)
        let viewController = PublisherViewController.instantiate()
