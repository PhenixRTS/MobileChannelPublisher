...
import com.phenixrts.suite.phenixcore.repositories.core.common.PHENIX_CORE_TIMBER_TAG
...
class FileWriterDebugTree(private val context: Application) : Timber.DebugTree() {
    ...
    override fun createStackElementTag(element: StackTraceElement) =
        "$PHENIX_CORE_TIMBER_TAG: (${element.fileName}:${element.lineNumber}) #${element.methodName} "
    ...
    override fun log(priority: Int, message: String?, vararg args: Any?) {
        ...
        formatAndLogMessage(PHENIX_CORE_TIMBER_TAG, priority, message, null)
    }

    override fun log(priority: Int, t: Throwable?, message: String?, vararg args: Any?) {
        super.log(priority, t, message, *args)
        formatAndLogMessage(PHENIX_CORE_TIMBER_TAG, priority, message, t)
    }
